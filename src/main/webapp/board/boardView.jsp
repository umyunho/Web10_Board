	...
	<div id="main_container">
		...
		<div class="board">
			...
			<div class="field">
				...
				<div class="text"><fmt:formatDate type="both" value="${board.writedate}"/></div>	
			</div>						
			<div class="field">
	        ...
	        <div class="login-button">
	            ...
	            <input type="button" class="btn-login" value="목록보기" onclick="location.href = 'board.do?command=main'"/>
	        </div>		
		</div>
		<div class="reply">
